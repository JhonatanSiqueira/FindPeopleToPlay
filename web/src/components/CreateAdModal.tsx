...
export function CreateAdModal(){
    ...
    return(
        <Dialog.Portal>
          ...
          <Dialog.Content className='fixed bg-[#242634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-md shadow-black/100'>
            <Dialog.Title className='text-3xl font-black'> Publique um anúncio</Dialog.Title>
              ...
              <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                ...
                <footer className='mt-4 flex justify-end gap-4'>
                  <Dialog.Close className='bg-zinc-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3 hover:bg-zinc-600'>Cancelar</Dialog.Close>
                  <button 
                  type='submit'
